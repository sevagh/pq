...
fn parse_default_value(value: &str, field_type: &InternalFieldType) -> serde_protobuf_error::Result<value::Value> {
    use std::str::FromStr;

    fn bad(v: &str) -> serde_protobuf_error::Error {
        serde_protobuf_error::ErrorKind::BadDefaultValue(v.to_owned()).into()
    }
