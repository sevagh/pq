...
impl<'de> serde::de::MapAccess<'de> for MessageVisitor<'de> {
    ...
    #[inline]
    fn next_key_seed<K>(&mut self, seed: K) -> serde_protobuf_error::Result<Option<K::Value>>
    ...
    #[inline]
    fn next_value_seed<V>(&mut self, seed: V) -> serde_protobuf_error::Result<V::Value>
...
impl<'de> serde::Deserializer<'de> for MessageKeyDeserializer<'de> {
    ...
    #[inline]
    fn deserialize_any<V>(self, visitor: V) -> serde_protobuf_error::Result<V::Value>
        where V: serde::de::Visitor<'de>
    {
...
impl<'de> serde::Deserializer<'de> for MessageFieldDeserializer<'de> {
    ...
    #[inline]
    fn deserialize_any<V>(mut self, visitor: V) -> serde_protobuf_error::Result<V::Value>
        where V: serde::de::Visitor<'de>
    {
        ...
        match self.field.take() {
            ...
            None => bail!(serde_protobuf_error::ErrorKind::EndOfStream),
        }
    }
}
...
impl<'de> serde::de::SeqAccess<'de> for RepeatedValueVisitor<'de> {
    ...
    #[inline]
    fn next_element_seed<A>(&mut self, seed: A) -> serde_protobuf_error::Result<Option<A::Value>>
...
fn visit_value<'de, V>(descriptors: &'de descriptor::Descriptors,
                       ...
                       value: value::Value,
                       visitor: V)
                       -> serde_protobuf_error::Result<V::Value>
    where V: serde::de::Visitor<'de>
{
    match value {
