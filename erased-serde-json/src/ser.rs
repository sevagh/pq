...
pub trait Formatter {
    fn erased_write_null(&mut self, writer: &mut io::Write) -> Result<(), io::Error>;
    fn erased_write_bool(&mut self, writer: &mut io::Write, value: bool) -> Result<(), io::Error>;
    fn erased_write_i8(&mut self, writer: &mut io::Write, value: i8) -> Result<(), io::Error>;
    fn erased_write_i16(&mut self, writer: &mut io::Write, value: i16) -> Result<(), io::Error>;
    fn erased_write_i32(&mut self, writer: &mut io::Write, value: i32) -> Result<(), io::Error>;
    fn erased_write_i64(&mut self, writer: &mut io::Write, value: i64) -> Result<(), io::Error>;
    fn erased_write_u8(&mut self, writer: &mut io::Write, value: u8) -> Result<(), io::Error>;
    fn erased_write_u16(&mut self, writer: &mut io::Write, value: u16) -> Result<(), io::Error>;
    fn erased_write_u32(&mut self, writer: &mut io::Write, value: u32) -> Result<(), io::Error>;
    fn erased_write_u64(&mut self, writer: &mut io::Write, value: u64) -> Result<(), io::Error>;
    fn erased_write_f32(&mut self, writer: &mut io::Write, value: f32) -> Result<(), io::Error>;
    ...
    T: serde_json::ser::Formatter,
{
    ...
    fn erased_write_bool(&mut self, w: &mut io::Write, v: bool) -> Result<(), io::Error> {
        self.write_bool(w, v)
    }
    fn erased_write_i8(&mut self, w: &mut io::Write, v: i8) -> Result<(), io::Error> {
        self.write_i8(w, v)
    }
    fn erased_write_i16(&mut self, w: &mut io::Write, v: i16) -> Result<(), io::Error> {
        self.write_i16(w, v)
    }
    fn erased_write_i32(&mut self, w: &mut io::Write, v: i32) -> Result<(), io::Error> {
        self.write_i32(w, v)
    }
    fn erased_write_i64(&mut self, w: &mut io::Write, v: i64) -> Result<(), io::Error> {
        self.write_i64(w, v)
    }
    fn erased_write_u8(&mut self, w: &mut io::Write, v: u8) -> Result<(), io::Error> {
        self.write_u8(w, v)
    }
    fn erased_write_u16(&mut self, w: &mut io::Write, v: u16) -> Result<(), io::Error> {
        self.write_u16(w, v)
    }
    fn erased_write_u32(&mut self, w: &mut io::Write, v: u32) -> Result<(), io::Error> {
        self.write_u32(w, v)
    }
    fn erased_write_u64(&mut self, w: &mut io::Write, v: u64) -> Result<(), io::Error> {
        self.write_u64(w, v)
    }
    fn erased_write_f32(&mut self, w: &mut io::Write, v: f32) -> Result<(), io::Error> {
        self.write_f32(w, v)
    }
    fn erased_write_f64(&mut self, w: &mut io::Write, v: f64) -> Result<(), io::Error> {
        self.write_f64(w, v)
    }
    fn erased_begin_string(&mut self, w: &mut io::Write) -> Result<(), io::Error> {
        self.begin_string(w)
    }
    ...
    fn erased_begin_array(&mut self, w: &mut io::Write) -> Result<(), io::Error> {
        self.begin_array(w)
    }
    ...
    fn erased_begin_object(&mut self, w: &mut io::Write) -> Result<(), io::Error> {
        self.begin_object(w)
    }
    fn erased_end_object(&mut self, w: &mut io::Write) -> Result<(), io::Error> {
        self.end_object(w)
    }
    fn erased_begin_object_key(&mut self, w: &mut io::Write, first: bool) -> Result<(), io::Error> {
        self.begin_object_key(w, first)
    }
    fn erased_end_object_key(&mut self, w: &mut io::Write) -> Result<(), io::Error> {
        self.end_object_key(w)
    }
    fn erased_begin_object_value(&mut self, w: &mut io::Write) -> Result<(), io::Error> {
        self.begin_object_value(w)
    }
    fn erased_end_object_value(&mut self, w: &mut io::Write) -> Result<(), io::Error> {
...
impl_formatter_for_trait_object!(Formatter);
impl_formatter_for_trait_object!(&'a mut Formatter);
impl_formatter_for_trait_object!(&'a mut (Formatter + Send));
impl_formatter_for_trait_object!(&'a mut (Formatter + Sync));
impl_formatter_for_trait_object!(&'a mut (Formatter + Send + Sync));
